...
/**
 * @deprecated This component is being replaced by BillsPage in the pages directory.
...
function BillList() {
  ...
  useEffect(() => {
    const fetchBills = async () => {
      try {
        ...
        logger.error("Error fetching bills", { error: err });
  ...
  const handleSearch = async (searchParams) => {
    try {
      ...
      logger.error("Error searching bills", { error: err });
  ...
  const mockBills = [
    ...
    },
    {
      id: 2,
      title: "SB 5678",
      description: "An act relating to healthcare reform",
      state: "NY",
      status: "Passed",
    },
    {
      id: 3,
      title: "HB 9012",
      description: "An act relating to transportation infrastructure",
      state: "TX",
      status: "Introduced",
    },
    {
      id: 4,
      title: "SB 3456",
      description: "An act relating to environmental protection",
      state: "WA",
      status: "In Committee",
    },
    {
      id: 5,
      title: "HB 7890",
      description: "An act relating to criminal justice reform",
      state: "IL",
      status: "Passed",
    },
  ];
