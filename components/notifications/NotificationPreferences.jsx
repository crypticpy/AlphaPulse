        ...
        <div className="space-y-4">
          <div className="flex items-start">
            ...
            <div className="ml-3 text-sm">
              <label
                htmlFor="billStatusUpdates"
                className="font-medium text-gray-700 dark:text-gray-200"
              >
                Bill Status Updates
              </label>
              <p className="text-gray-500 dark:text-gray-400">
                Receive notifications when bills you&apos;re tracking change
                status
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3 text-sm">
              <label
                htmlFor="similarBillAlerts"
                className="font-medium text-gray-700 dark:text-gray-200"
              >
                Similar Bill Alerts
              </label>
              <p className="text-gray-500 dark:text-gray-400">
                Receive notifications about bills similar to ones you&apos;re
                tracking
              </p>
            </div>
          </div>
